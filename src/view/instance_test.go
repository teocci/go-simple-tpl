...
func TestDefault(t *testing.T) {
	...
	// "error: ViewEngine render read name:layouts/master,  path:/go-simple-tpl/src/view/views/layouts/master.html, error: open /go-simple-tpl/src/view/views/layouts/master.html: The system cannot find the path specified"
	if err == nil {
